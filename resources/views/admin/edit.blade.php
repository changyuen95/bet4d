  ...
  @method('PUT')
    <div class="flex flex-wrap -mx-3 my-6">
      ...
      <div class="w-full md:w-4/5 px-3">
          ...
          <input class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-md cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none bg-neutral-200 dark:placeholder-gray-600" aria-describedby="user_avatar_help" id="user_avatar" name="user_avatar" type="file" accept=".jpg, .jpeg, .png">
    ...
    <div class="flex flex-wrap -mx-3 mb-2">
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:border-gray-500" id="admin-role" type="text" placeholder="Role" name="role" value="{{ old('role',$admin->role)}}" readonly>
        </div>
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
