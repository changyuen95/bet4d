...
Route::namespace('API')->group(function () {
    ...
    Route::prefix('draw-results')->group(function () {
        ...
        Route::any('trigger/stc-master','DrawResultController@stcMasterResult');
        Route::any('trigger/stc-master-staging','DrawResultController@stcMasterResultStaging');
...
Route::namespace('API')->prefix('admin')->middleware(['auth:sanctum', 'checkIsAdmin'])->group(function () {
    ...
    Route::prefix('me')->group(function () {
        ...
        Route::post('one-signal-test', 'Admin\MeController@oneSignalStaffTest');
    });
    ...
    Route::middleware(['checkUserType:'.Role::OPERATOR])->group(function () {
        ...
        Route::prefix('tickets')->group(function () {
            ...
            Route::post('{id}/modify-ticket-amounts','StaffTicketController@modifyTicketAmount');
